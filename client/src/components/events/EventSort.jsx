  ...
  return (
    <div className="w-full flex flex-col items-center gap-4 mb-10">
      <div className="flex flex-row gap-3 items-center w-full max-w-lg">
        ...
        />
        <button
          className={`h-11 w-11 rounded-xl flex items-center justify-center shrink-0 border transition-all duration-300 active:scale-90 ${
            showFilter
              ? "bg-stone-900 border-stone-800 text-amber-300 shadow-md rotate-180"
